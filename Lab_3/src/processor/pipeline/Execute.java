...
public class Execute {
	...
	private boolean b;	// Checks for "immediate" type function (R2I-Type) - switch
	...
	public void performEX() {
		...
		if (OF_EX_Latch.isEX_enable()) {
			...
			int aluResult = 0;
			b = opType.equals("addi") || opType.equals("subi") || opType.equals("muli") || opType.equals("divi")
			...
			if (b) {
				...
				switch (opType) {
					...
					case "store":
						...
						break;
					default:
						System.out.print("Issue detected in src.processor.pipeline.Execute.java, switch(OpType) for R2I");
				}
			} 
			// R3 switch -type
				...
				switch (opType) {
					...
					case "sra":
						...
						break;
					default:
						System.out.print("Issue detected in R3 type switch, check file: src.processor.pipeline.Execute.java");
				}
			} 
				...
				if (jmpType == OperandType.Immediate)
					...
					immed = containingProcessor.getRegisterFile()
