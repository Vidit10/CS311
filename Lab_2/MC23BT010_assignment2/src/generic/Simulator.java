...
public class Simulator {
	...
	public static void assemble(String objectProgramFile)
	{
		...
		try{
			// 1. To the objectProgramFile in binary mode
			...
			for(int i=0; i<ParsedProgram.code.size(); i++){
				...
				if(opType.equals("jmp")){
					...
					bisaun += "00000"; // no register is used for jmp 
					int destAddr = 0;
			...
			// 5. Done with work, close the file :D
			mech.close();
